  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        <h1 class="display-4 font-weight-normal">Chat With Me</h1>
        <p class="lead font-weight-normal">Using out chat applcation you can freely chat with your friends without any hesitation.</p>
            <form action="claim.php" method="post">
                ChatWithMe.com/ <input type="text" name="room">
